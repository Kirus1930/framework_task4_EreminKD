...
В данном проекте реализована веб-служба на ASP.NET Core, моделирующая процесс бронирования переговорной комнаты с использованием машины состояний, поддержкой идемпотентности, компенсации при сбоях и средствами наблюдаемости.
